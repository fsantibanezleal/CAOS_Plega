...
| `dev` | Read-only data verification, then Vite at `127.0.0.1:5903/CAOS_Plega/`; no service worker |
...
| `preview` | Verify and serve `build/pages` at `127.0.0.1:4903/CAOS_Plega/` |
