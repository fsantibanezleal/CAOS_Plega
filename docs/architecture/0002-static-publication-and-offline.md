...
PLEGA needs anonymous access, portable local projects and predictable print exports without a private runtime service. Use GitHub Pages at the default project prefix `/CAOS_Plega/`. No CNAME, VPS, remote font, private package or runtime secret is required.
